...
<script>
	...
	import {
		administrativeConfig, mapTooltipConfig, topDataConfig,
		...
		methods   : {
			...
			loadanalysisBySynthesisList() {
				let cityname = [],
					...
					kyjc = [],
					tblylx = [];
				const analysisBySynthesisList =  this.analysisBySynthesisList.slice(0, 15);
				for(var i = 0; i < analysisBySynthesisList.length; i++) {
