<template>
    <div class="map-page">
        <div id="newjBox"  :style="{width: '1200px', height: '300px'}"></div>
    </div>
</template>
<script>
 ...
 */
 loadMap(mapCode, name) {
    ...
    // });
        ...
        mapHandle(){
            var newjBox = this.$echarts.init(document.getElementById("newjBox"));
...
this.loadMap('/asset/get/s/data-1527045631990-r1dZ0IM1X.json', 'china'); //初始化全国地图
            // 绘制图表
      newjBox.setOption(option);
        }
    }
}
</script>
